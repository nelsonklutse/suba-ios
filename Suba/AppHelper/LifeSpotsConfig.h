...
#define k_TAG_HINT_SHOWN @"tagHintShown"
...
#define kSUBA_TAG_COLOR  [UIColor colorWithRed:51/255.0f green:51/255.0f blue:51/255.0f alpha:1.0f]
...
#define kTAG_PHOTO_PATH @"photo/tag"
#define kGET_PHOTO_TAGS_PATH @"photo/tags"
#define kREMOVE_PHOTO_TAG_PATH @"photo/tag/remove"
#define kMATCH_TAG_TO_USER_PATH @"tag/matchuser"
