...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    DLog(@"Parent %@",self.parentViewController.childViewControllers);
    UIViewController *viewController = self.parentViewController.childViewControllers.lastObject;
    ...
    if ([segue.identifier isEqualToString:kFromUserSpotsToPhotosStreamSegue]){
        ...
        if ([segue.destinationViewController isKindOfClass:[PhotoStreamViewController class]]){
            ...
            if (sender[@"photoURL"]) {
                ...
                //photosVC.spotName  = sender[@"streamName"];
