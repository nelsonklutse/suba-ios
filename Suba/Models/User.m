...
+(void)searchUserMatchingNames:(NSDictionary *)params completion:(GeneralCompletion)completion
{
    [[SubaAPIClient sharedInstance] GET:@"users/search" parameters:params success:^(NSURLSessionDataTask *task, id responseObject) {
        completion(responseObject,nil);
    } failure:^(NSURLSessionDataTask *task, NSError *error) {
        completion(nil,error);
    }];
...
+(void)tagUser:(NSDictionary *)params completion:(GeneralCompletion)completion
{
    [[SubaAPIClient sharedInstance] POST:@"photo/tag" parameters:params success:^(NSURLSessionDataTask *task, id responseObject) {
        completion(responseObject,nil);
    } failure:^(NSURLSessionDataTask *task, NSError *error) {
        completion(nil,error);
    }];
...
+(void)getTagsForPhoto:(NSDictionary *)params completion:(GeneralCompletion)completion
{
    [[SubaAPIClient sharedInstance] GET:kGET_PHOTO_TAGS_PATH parameters:params success:^(NSURLSessionDataTask *task, id responseObject) {
        completion(responseObject,nil);
    } failure:^(NSURLSessionDataTask *task, NSError *error) {
        completion(nil,error);
    }];
...
+(void)removTag:(NSDictionary *)params completion:(GeneralCompletion)completion
{
    [[SubaAPIClient sharedInstance] POST:kREMOVE_PHOTO_TAG_PATH parameters:params success:^(NSURLSessionDataTask *task, id responseObject) {
        completion(responseObject,nil);
    } failure:^(NSURLSessionDataTask *task, NSError *error) {
        completion(nil,error);
    }];
