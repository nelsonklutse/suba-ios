...
/**
 *
 * The  text contained in the popover
 */
...
/**
 * 
 * The bounds of the text contained in the popover
 */
...
/** Long Press handler
 *
 * A block that will be fired when the user long presses the popover.
 */
@property (nonatomic, copy) void (^longPressHandler)();
