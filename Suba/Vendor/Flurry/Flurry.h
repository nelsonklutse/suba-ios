 ...
 *  - (void)interestingAppAction 
 {
 [FBAppEvents logEvent:@"Interesting_Action"];
 ...
 *  - (void)userPurchasedSomethingCool 
 ...
 nil];
 [FBAppEvents logEvent:@"Something Cool Purchased" withParameters:params];
 // Give user cool item
 }
 *  @endcode
 * 
 ...
 *  - (void)startLevel 
 {
 [FBAppEvents logEvent:@"Level Played" timed:YES];
 // Start user on level
 }
 ...
 *  - (void)startLevel 
 ...
 [FBAppEvents logEvent:@"Level Played" withParameters:params timed:YES];
 // Start user on level
 }
