...
- (CGRect)frameForPageAtIndex:(NSUInteger)index {
    ...
    //DLog(@"Page frame is %@ at index %i",NSStringFromCGRect(pageFrame),index);
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    ...
    if ([_delegate respondsToSelector:@selector(photoBrowser:hideTagsForPhotoAtIndex:)]) {
        DLog(@"Tell delegate to hide tags");
        [_delegate photoBrowser:self hideTagsForPhotoAtIndex:_currentPageIndex];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if ([_delegate respondsToSelector:@selector(photoBrowser:showTagsForPhotoAtIndex:)]) {
        DLog(@"Tell delegate to show tags");
        [_delegate photoBrowser:self showTagsForPhotoAtIndex:_currentPageIndex];
    }
    
	[self updateNavigation];
    
    DLog(@"scroll view did end decelerating");
}
...
- (void)setControlsHidden:(BOOL)hidden animated:(BOOL)animated permanent:(BOOL)permanent {
    ...
    DLog(@"Toggle controls: current page index: %i",_currentPageIndex);
